...
type Store interface {
	...
	ListDispatchableRAGIndexTasksPage(ctx context.Context, afterID int64, limit int) ([]RAGIndexTaskDispatchCandidate, int64, error)
	GetDispatchableRAGIndexTaskByID(ctx context.Context, taskID int64) (*RAGIndexTaskDispatchCandidate, error)
	MarkRAGIndexTaskDispatched(ctx context.Context, candidate RAGIndexTaskDispatchCandidate) (bool, error)
	ArmExpiredRAGIndexTasksPage(ctx context.Context, afterID int64, limit int) ([]RAGIndexTaskDispatchCandidate, int64, error)
	CaptureRAGFairQueueHighWater(ctx context.Context) (int64, error)
	ListCanonicalRAGTenantsPage(ctx context.Context, highWater int64, afterUserID string, limit int) ([]string, string, error)
	ListDispatchedRAGIndexTasksPage(ctx context.Context, highWater, afterTaskID int64, limit int) ([]RAGIndexTaskRecord, int64, error)
	ListValidRunningRAGIndexTasksPage(ctx context.Context, highWater, afterTaskID int64, limit int) ([]RAGIndexTaskRunningSnapshot, int64, error)
	CaptureRAGBrokerRepairHighWater(ctx context.Context) (int64, error)
	ListBrokerBackedRAGCandidatesPage(ctx context.Context, highWater, afterTaskID int64, limit int) ([]RAGIndexTaskDispatchCandidate, int64, error)
	RearmRAGCandidateAfterBrokerLoss(ctx context.Context, original RAGIndexTaskDispatchCandidate) (*RAGIndexTaskDispatchCandidate, bool, error)
